...
export default function CheckStatus() {
  ...
  const getStatusColor = (statusText: string): string => {
    ...
    if (lower.includes('complete') || lower.includes('ready'))
  ...
  const handleCheck = async () => {
    ...
    if (!validatePhone(phone)) {
      setError(
        'Please enter a valid 10-digit Kenyan mobile number (e.g., 0712345678)'
      )
      return
    }
          ...
          <div className='p-8'>
            <div className='text-center mb-8'>
              ...
              <p className='text-slate-400 text-sm'>
                Enter your details to view your queue position
              </p>
            </div>
            ...
            <div className='space-y-5'>
              <div className='space-y-2'>
                <label
                  htmlFor='fullName'
                  className='flex items-center gap-2 text-xs font-semibold text-slate-300 uppercase tracking-wide'
                >
                  <User
              ...
              <div className='space-y-2'>
                ...
                <p
                  id='phone-help'
                  className='flex items-center gap-1.5 text-xs text-slate-500 ml-1'
                >
            ...
            {status && (
              ...
              >
                ...
                <div className='flex items-start gap-4'>
                  {StatusIcon && (
                    <div
                      className={`p-2.5 bg-gradient-to-br ${getStatusColor(
                        status.status
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    <div className='space-y-2'>
                      ...
                      <div className='flex items-center justify-between p-3 bg-slate-800/40 rounded-lg border border-slate-700/50'>
                        ...
                        <span
                          className={`font-semibold text-sm px-3 py-1 rounded-md bg-gradient-to-r ${getStatusColor(
                            status.status
            ...
            {error && (
              ...
              >
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div className='flex-1 min-w-0'>
                    <h2 className='font-semibold text-base text-red-100 mb-1'>
